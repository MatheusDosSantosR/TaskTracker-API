...
export class CommentService {
    ...
    async updateComment(body: Comment, commentId: number, userId: number) {
        ...
        if (!existingComment) throw new Error('Comentário não encontrado ou usuário sem permissão');
    ...
    async deleteComment(commentId: number, userId: number) {
        ...
        if (!comment) throw new Error('Comentário não encontrado ou usuário sem permissão');
